...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    // Hero
    'hero.badge': 'Visionnaire • Gérant • Entrepreneur',
    'hero.title': 'Inocent KOFFI',
    'hero.subtitle': 'Gérant d\'AGRICAPITAL SARL',
    ...
    // SEO
    'seo.home.title': 'Inocent KOFFI - Gérant AGRICAPITAL SARL | Transformation Agricole',
    'seo.home.description': 'Inocent KOFFI, Gérant d\'AGRICAPITAL SARL. 12 ans d\'expérience terrain auprès des producteurs agricoles en Côte d\'Ivoire.',
  ...
  en: {
    ...
    // Hero
    'hero.badge': 'Visionary • Managing Director • Entrepreneur',
    'hero.title': 'Inocent KOFFI',
    'hero.subtitle': 'Managing Director of AGRICAPITAL SARL',
    ...
    // SEO
    'seo.home.title': 'Inocent KOFFI - Managing Director AGRICAPITAL SARL | Agricultural Transformation',
    'seo.home.description': 'Inocent KOFFI, Managing Director of AGRICAPITAL SARL. 12 years of field experience with agricultural producers in Côte d\'Ivoire.',
  ...
  es: {
    ...
    // Hero
    'hero.badge': 'Visionario • Gerente • Emprendedor',
    'hero.title': 'Inocent KOFFI',
    'hero.subtitle': 'Gerente de AGRICAPITAL SARL',
    ...
    // SEO
    'seo.home.title': 'Inocent KOFFI - Gerente AGRICAPITAL SARL | Transformación Agrícola',
    'seo.home.description': 'Inocent KOFFI, Gerente de AGRICAPITAL SARL. 12 años de experiencia en el campo con productores agrícolas en Costa de Marfil.',
  ...
  de: {
    ...
    // Hero
    'hero.badge': 'Visionär • Geschäftsführer • Unternehmer',
    'hero.title': 'Inocent KOFFI',
    'hero.subtitle': 'Geschäftsführer von AGRICAPITAL SARL',
    ...
    // SEO
    'seo.home.title': 'Inocent KOFFI - Geschäftsführer & GF AGRICAPITAL SARL | Agrartransformation',
    'seo.home.description': 'Inocent KOFFI, Geschäftsführer von AGRICAPITAL SARL. 12 Jahre Felderfahrung mit landwirtschaftlichen Produzenten in der Elfenbeinküste.',
