...
export const translations: Record<Language, Record<string, string>> = {
  ...
  bci: {
    'nav.home': 'Awlo',
    'nav.about': 'Min su ndɛ',
    'nav.vision': 'Ɲrun ninnge',
    'nav.agricapital': 'AGRICAPITAL',
    'nav.projects': 'Junman mun',
    'nav.partnership': 'Bo yolɛ',
    'nav.blog': 'Ndɛ klɛlɛ',
    'nav.contact': 'Flɛ min',
    'nav.gallery': 'Nzɔliɛ mun',
    'hero.badge': 'Ɲrun nianfuɛ • Kpɛnngbɛn • Junman difuɛ',
    'hero.title': 'Inocent KOFFI',
    'hero.subtitle': 'AGRICAPITAL SARL i kpɛnngbɛn',
    'hero.description': 'Fie junman kacilɛ Côte d’Ivoire lɔ, atin kpa su, sran kwlaa ti. Afuɛ 12 min nin fie difuɛ mun e trannin klɔ mun nun.',
    'hero.cta.discover': 'Nian min ɲrun ninnge',
    'hero.cta.contact': 'Flɛ min',
    'about.badge': 'Min su ndɛ',
    'about.title': 'Ajalɛ kun fie junman ti',
    'about.description': 'Kɛ ɔ fin afuɛ 2012 nun, n sinnin klɔ 100 tra su, akpasua 8 nun Côte d’Ivoire lɔ, naan n wun fie difuɛ mun i afiɛn ninnge kwlaa.',
    'about.experience': 'Afuɛ 12 tra su silɛ',
    'about.regions': 'Akpasua 8 sinlɛ',
    'about.localities': 'Klɔ 100 tra su nianlɛ',
    'about.producers': 'Fie difuɛ 500 tra su ukalɛ',
    'vision.badge': 'Ɲrun ninnge',
    'vision.title': 'Kaci Afrika fie junman',
    'vision.description': 'Min ɲinsu: fie difuɛ mun fin nguan kekle nun be ba aɲanbeun nun, naan gbanflɛn mun nian be su.',
    'services.badge': 'Ukalɛ mun',
    'services.title': 'Silɛ nin ukalɛ',
    'services.impact.title': 'Kacilɛ',
    'services.impact.description': 'Fie junman kacilɛ: sika, sran mun, klɔ nin asiɛ su ninnge kwlaa.',
    'services.financing.title': 'Sika manlɛ nin sika fa gualɛ',
    'services.financing.description': 'Atin uflɛ kpa mun fa sika man fie junman dandan mun.',
    'services.technical.title': 'Junman su ukalɛ',
    'services.technical.description': 'Afuɛ 12 fie su silɛ kaci ninnge kpa nga be yo i sakpa su.',
    'gallery.badge': 'Nzɔliɛ nun',
    'gallery.title': 'Nzɔliɛ fluwa',
    'gallery.description': 'Nian AGRICAPITAL SARL i bo bolɛ cɛn ninnge, 19 Novanblu 2025. Cɛn sɔ yɛ fie junman blɛ uflɛ boli i bo Haut-Sassandra lɔ.',
    'gallery.filter.all': 'Kwlaa',
    'gallery.filter.launch': 'Bo bolɛ',
    'gallery.filter.community': 'Klɔ sran mun',
    'gallery.filter.training': 'Like klelɛ',
    'testimonials.badge': 'Ndɛ nga be kan',
    'testimonials.title': 'Ndɛ nga be kan min su',
    'testimonials.description': 'Tie sran nga be nin Inocent KOFFI nin AGRICAPITAL be di junman be ndɛ.',
    'testimonials.leave': 'Kan ɔ ndɛ',
    'testimonials.seeAll': 'Nian ndɛ mun kwlaa',
    'partnership.badge': 'Bo yolɛ',
    'partnership.title': 'Kaci e bo yofuɛ',
    'partnership.description': 'Bɛ e wun junman nga ɔ kaci Côte d’Ivoire fie junman.',
    'partnership.cta': 'Kaci bo yofuɛ',
    'contact.badge': 'Flɛ min',
    'contact.title': 'E koko ɔ junman ndɛ',
    'contact.description': 'Nán ɲin kpli, flɛ min sɛ a kunndɛ kosan annzɛ junman bo likawlɛ.',
    'contact.form.name': 'Ɔ dunman kwlaa',
    'contact.form.email': 'Email',
    'contact.form.phone': 'Telefɔnu',
    'contact.form.message': 'Ndɛ',
    'contact.form.submit': 'Fa ndɛ’n kɔ',
    'contact.form.sending': 'Ɔ su kɔ...',
    'contact.success': 'Ndɛ’n ɔli kpa!',
    'newsletter.badge': 'Ndɛ uflɛ mun',
    'newsletter.title': 'Tie ndɛ uflɛ mun',
    'newsletter.description': 'Klɛ ɔ dunman naan e fa ndɛ uflɛ mun blɛ ɔ.',
    'newsletter.placeholder': 'Ɔ email',
    'newsletter.subscribe': 'Klɛ ɔ dunman',
    'footer.rights': 'Atin kwlaa ti be liɛ',
    'footer.legal': 'Mmla ndɛ mun',
    'footer.privacy': 'Ɔ bɔbɔ liɛ sielɛ mmla',
    'faq.badge': 'Kosan mun',
    'faq.title': 'Kosan nga be usa kpɛ sunman',
    'faq.description': 'Wun tɛlɛ nga be tra AGRICAPITAL nin e junman su kosan mun.',
    'faq.q1': 'Ngue yɛ AGRICAPITAL ti niɔn?',
    'faq.a1': 'AGRICAPITAL SARL ti Côte d’Ivoire junman sua kun nga Inocent KOFFI boli i bo, i junman ti Afrika fie junman kacilɛ tititi. E uka fie difuɛ mun: sika manlɛ, like klelɛ nin atin kpa nga be fa be ninnge yo atɛ.',
    'faq.q2': 'Wafa sɛ yɛ n kwla kaci bo yofuɛ ɔ?',
    'faq.a2': 'Klɛ ɔ ndɛ Bo yolɛ bue su. E kplin su sika fafuɛ, junman silɛfuɛ, mɛn su junman sua nin atɛ yofuɛ mun. E sran mun bɛ flɛ ɔ naan amun koko junman ndɛ.',
    'faq.q3': 'Nin lɔ yɛ AGRICAPITAL di junman ɔ?',
    'faq.a3': 'E di junman Haut-Sassandra akpasua nun Côte d’Ivoire lɔ, e sua ti Daloa. E silɛ tra akpasua 8 nin klɔ 100 tra su mɛn’n nun.',
    'faq.q4': 'Ninnge benin yɛ amun ta be niɔn?',
    'faq.a4': 'E fie nga ɔ ti ektaa 50, e ta mmɔ waka mma kpakpa. E uka kakao, kafe nin aliɛ ninnge difuɛ mun wie.',
    'faq.q5': 'Wafa sɛ yɛ n kwla flɛ Inocent KOFFI ɔ?',
    'faq.a5': 'Klɛ email Inocent.koffi@agricapital.ci annzɛ flɛ telefɔnu +225 07 59 56 60 87. A kwla fa e ndɛ klɛlɛ bue su wie.',
    'faq.q6': 'AGRICAPITAL man atin kɛ sran fa i sika gua nun?',
    'faq.a6': 'Ɔ ti su. AGRICAPITAL man atin kɛ sran fa i sika gua Côte d’Ivoire fie junman nun naan ɔ ɲan kpa. Flɛ e naan e kan i ndɛ kwlaa kle ɔ.',
    'common.readMore': 'Si i ndɛ kpanngban',
    'common.learnMore': 'Si i ndɛ kpanngban',
    'common.back': 'Sa sin',
    'common.next': 'Nga ɔ su su',
    'common.previous': 'Nga ɔ dun mmua',
    'common.share': 'Fa kle sran mun',
    'evolution.badge': 'Ɲrun kɔlɛ',
    'evolution.title': 'E atin',
    'evolution.description': 'Nian e junman ɲrun kɔlɛ ninnge dandan mun.',
    'evolution.timeline': 'Junman blɛ nun ndɛ',
    'blog.badge': 'Ndɛ klɛlɛ',
    'blog.title': 'Ndɛ uflɛ nin fluwa mun',
    'blog.description': 'Ndɛ uflɛ mun Afrika fie junman nin AGRICAPITAL su.',
    'blog.readMore': 'Kanngan i kwlaa',
    'blog.relatedPosts': 'Fluwa nga be nin i sɛ',
    'blog.noPostsYet': 'Fluwa fi nunman lɛ siɛn.',
    'blog.comingSoon': 'Fluwa mun bɛ ka kan...',
    'blog.featured': 'Fluwa dandan mun',
    'blog.thoughts': 'Akunndan nin ɲrun ninnge',
    'blog.thoughtsDesc': 'Akunndan fie junman, junman bolɛ nin Afrika kacilɛ su',
    'blog.viewAll': 'Nian fluwa mun kwlaa',
    'comments.title': 'Ndɛ nga be kan',
    'comments.leave': 'Kan ɔ ndɛ wie',
    'comments.noComments': 'Sran fi nin i ndɛ nunman lɛ. Yo klikli su!',
    'comments.success': 'Ɔ ndɛ’n ɔli',
    'comments.pending': 'Ɔ ndɛ’n bɛ yi i nglo kɛ be nian su.',
    'comments.error': 'Sa kun tɔli',
    'comments.errorMessage': 'Ndɛ’n w’a kɔman.',
    'comments.required': 'Bue nga be kunndɛ',
    'comments.fillAll': 'Klɛ ninnge kwlaa nun.',
    'comments.submit': 'Fa ndɛ’n kɔ',
    'comments.moderation': 'Ɔ ndɛ’n bɛ yi i nglo kɛ junman su kpɛn nian su.',
    'comments.namePlaceholder': 'Ɔ dunman',
    'comments.emailPlaceholder': 'ɔ@email.com',
    'comments.comment': 'Ndɛ',
    'comments.commentPlaceholder': 'Kan ɔ akunndan...',
    'seo.home.title': 'Inocent KOFFI - AGRICAPITAL SARL i kpɛnngbɛn | Fie junman kacilɛ',
    'seo.home.description': 'Inocent KOFFI, AGRICAPITAL SARL i kpɛnngbɛn. Afuɛ 12 fie difuɛ mun be wun Côte d’Ivoire lɔ.',
    'seo.about.title': 'Min su ndɛ - Inocent KOFFI | Ajalɛ nin fie junman silɛ',
    'seo.about.description': 'Nian Inocent KOFFI i ajalɛ: afuɛ 12 akpasua 8 nun Côte d’Ivoire lɔ klɔ sran mun be wun.',
    'seo.vision.title': 'Ɲrun ninnge - Inocent KOFFI | Kaci Afrika fie junman',
    'seo.vision.description': 'Inocent KOFFI i ɲrun ninnge: kaci Afrika fie junman atin kpa nin tititi liɛ su.',
    'seo.contact.title': 'Flɛ min - Inocent KOFFI | Junman bo likawlɛ',
    'seo.contact.description': 'Flɛ Inocent KOFFI naan amun koko fie junman, bo yolɛ annzɛ junman uflɛ ndɛ.',
  },
  dyu: {
    'nav.home': 'So kɔnɔ',
    'nav.about': 'N ka kunnafoni',
    'nav.vision': 'Hakilinata',
    'nav.agricapital': 'AGRICAPITAL',
    'nav.projects': 'Baaraw',
    'nav.partnership': 'Jɛɲɔgɔnya',
    'nav.blog': 'Sɛbɛnw',
    'nav.contact': 'Ne weele',
    'nav.gallery': 'Jaw',
    'hero.badge': 'Hakilinata tigi • Ɲɛmɔgɔ • Baarakɛla',
    'hero.title': 'Inocent KOFFI',
    'hero.subtitle': 'AGRICAPITAL SARL ɲɛmɔgɔ',
    'hero.description': 'Ka sɛnɛ yiriwa Kotidiwari, sira ɲuman kan, mɔgɔ bɛɛ ye. San 12 ne ni sɛnɛkɛlaw ye togodaw la.',
    'hero.cta.discover': 'Ne ka hakilinata lajɛ',
    'hero.cta.contact': 'Ne weele',
    'about.badge': 'N ka kunnafoni',
    'about.title': 'Sira min bɛ sɛnɛ ye',
    'about.description': 'Kabini san 2012, ne taara dugu 100 ni kɔ, mara 8 kɔnɔ Kotidiwari, walasa ka sɛnɛkɛlaw ka koow faamu.',
    'about.experience': 'San 12 ni kɔ dɔnniya',
    'about.regions': 'Mara 8 taama',
    'about.localities': 'Dugu 100 ni kɔ lajɛli',
    'about.producers': 'Sɛnɛkɛla 500 ni kɔ dɛmɛ',
    'vision.badge': 'Hakilinata',
    'vision.title': 'Ka Afiriki sɛnɛ yiriwa',
    'vision.description': 'Ne ka dannaya: sɛnɛkɛlaw ka bɔ dɛsɛ la ka don nafolo la, walasa kamalenw ka u ladege.',
    'services.badge': 'Dɛmɛw',
    'services.title': 'Dɔnniya ni dɛmɛ',
    'services.impact.title': 'Nafa',
    'services.impact.description': 'Sɛnɛ yiriwali: nafolo, mɔgɔya, sigida ani dugukolo lakana.',
    'services.financing.title': 'Wari sɔrɔ ni wari bila',
    'services.financing.description': 'Wari sɔrɔ sira kuraw sɛnɛ baara nafamaw kama.',
    'services.technical.title': 'Baara dɛmɛ',
    'services.technical.description': 'San 12 foro kɔnɔ dɔnniya kɛra fɛn ɲumanw ye tiɲɛ na.',
    'gallery.badge': 'Jaw la',
    'gallery.title': 'Ja marayɔrɔ',
    'gallery.description': 'AGRICAPITAL SARL daminɛ don jaw lajɛ, 19 nowanburu 2025. Don min kɛra sɛnɛ waati kura daminɛ ye Haut-Sassandra la.',
    'gallery.filter.all': 'Bɛɛ',
    'gallery.filter.launch': 'Daminɛ',
    'gallery.filter.community': 'Sigida',
    'gallery.filter.training': 'Kalanw',
    'testimonials.badge': 'Seereyaw',
    'testimonials.title': 'U ka fɔta',
    'testimonials.description': 'Mɔgɔ minnu ye baara kɛ ni Inocent KOFFI ni AGRICAPITAL ye, u ka seereyaw lajɛ.',
    'testimonials.leave': 'Seereya kɛ',
    'testimonials.seeAll': 'Seereya bɛɛ lajɛ',
    'partnership.badge': 'Jɛɲɔgɔnya',
    'partnership.title': 'Kɛ an jɛɲɔgɔn ye',
    'partnership.description': 'Don baara la min bɛ Kotidiwari sɛnɛ yiriwa.',
    'partnership.cta': 'Kɛ jɛɲɔgɔn ye',
    'contact.badge': 'Ne weele',
    'contact.title': 'An ka baro i ka baara kan',
    'contact.description': 'I kana siran, ne weele ɲininkali walima jɛ baara kama.',
    'contact.form.name': 'Tɔgɔ dafalen',
    'contact.form.email': 'Email',
    'contact.form.phone': 'Telefɔni',
    'contact.form.message': 'Cikan',
    'contact.form.submit': 'Cikan ci',
    'contact.form.sending': 'A bɛ ci la...',
    'contact.success': 'Cikan cira ka ɲɛ!',
    'newsletter.badge': 'Kunnafoni kuraw',
    'newsletter.title': 'I ka to kunnafoni la',
    'newsletter.description': 'I tɔgɔ sɛbɛn walasa ka kunnafoni kuraw sɔrɔ.',
    'newsletter.placeholder': 'I ka email',
    'newsletter.subscribe': 'I tɔgɔ sɛbɛn',
    'footer.rights': 'Josariyaw bɛɛ marara',
    'footer.legal': 'Sariya kunnafoni',
    'footer.privacy': 'Gundo lakana sariya',
    'faq.badge': 'Ɲininkaliw',
    'faq.title': 'Ɲininkali minnu bɛ kɛ tuma caman',
    'faq.description': 'AGRICAPITAL ni an ka baara kan ɲininkaliw jaabiw sɔrɔ yan.',
    'faq.q1': 'AGRICAPITAL ye mun ye?',
    'faq.a1': 'AGRICAPITAL SARL ye Kotidiwari baaraso ye, Inocent KOFFI y’a daminɛ, a ka baara ye Afiriki sɛnɛ yiriwali banbali ye. An bɛ sɛnɛkɛlaw dɛmɛ: wari sɔrɔ, kalan ni sugu sira.',
    'faq.q2': 'Ne bɛ se ka kɛ jɛɲɔgɔn ye cogo di?',
    'faq.a2': 'I ka fɔrimu dafa Jɛɲɔgɔnya ɲɛ kan. An bɛ sɔn wari bilalaw, dɔnniya baarakɛlaw, jɛkuluw ani feerekɛlaw ma. An ka jɛkulu bɛna i weele.',
    'faq.q3': 'AGRICAPITAL bɛ baara kɛ mara juman kɔnɔ?',
    'faq.a3': 'An bɛ baara kɛ kosɛbɛ Haut-Sassandra mara la Kotidiwari, an ka jɔyɔrɔba bɛ Daloa. An ka dɔnniya bɛ mara 8 ni dugu 100 ni kɔ kɔnɔ.',
    'faq.q4': 'Sɛnɛ fɛn juman ye aw ka baara ye?',
    'faq.a4': 'An ka sɛnɛyɔrɔ ektari 50 bɛ tulu-banan denw ɲumanw bɔ. An bɛ kakawo, kafe ni dumuni fɛnw sɛnɛkɛlaw fana dɛmɛ.',
    'faq.q5': 'Ne bɛ se ka Inocent KOFFI weele cogo di?',
    'faq.a5': 'I bɛ se ka email ci Inocent.koffi@agricapital.ci walima weele +225 07 59 56 60 87. I bɛ se ka fɔrimu fana kɛ an ka siti kan.',
    'faq.q6': 'AGRICAPITAL bɛ wari bilali sira di wa?',
    'faq.a6': 'Ɔwɔ, AGRICAPITAL bɛ wari bilali sira di Kotidiwari sɛnɛ baara la ni nafa ɲuman ye. An weele walasa ka dɔ dɔn an ka sariyaw kan.',
    'common.readMore': 'Ka dɔ dɔn',
    'common.learnMore': 'Ka dɔ dɔn',
    'common.back': 'Ka segin',
    'common.next': 'Nata',
    'common.previous': 'Tɛmɛnen',
    'common.share': 'Lafɔ ɲɔgɔn ma',
    'evolution.badge': 'Yiriwali',
    'evolution.title': 'An ka sira',
    'evolution.description': 'An ka yiriwali sen kolomaw lajɛ.',
    'evolution.timeline': 'Baara waati sira',
    'blog.badge': 'Sɛbɛnw',
    'blog.title': 'Kunnafoniw ni sɛbɛnw',
    'blog.description': 'Kunnafoni kuraw Afiriki sɛnɛ ni AGRICAPITAL kan.',
    'blog.readMore': 'Kalan ka taa ɲɛ',
    'blog.relatedPosts': 'Sɛbɛn suguya kelen',
    'blog.noPostsYet': 'Sɛbɛn si tɛ yen fɔlɔ.',
    'blog.comingSoon': 'Sɛbɛnw bɛna na sɔɔni...',
    'blog.featured': 'Sɛbɛn ɲumanw',
    'blog.thoughts': 'Miiriyaw ni hakilinata',
    'blog.thoughtsDesc': 'Miiriya sɛnɛ, baarada ni Afiriki yiriwali kan',
    'blog.viewAll': 'Sɛbɛn bɛɛ lajɛ',
    'comments.title': 'Hakilinaw',
    'comments.leave': 'I ka hakilina di',
    'comments.noComments': 'Hakilina si tɛ yen fɔlɔ. Kɛ fɔlɔ ye!',
    'comments.success': 'Hakilina cira',
    'comments.pending': 'I ka hakilina bɛna yira lajɛli kɔfɛ.',
    'comments.error': 'Fili',
    'comments.errorMessage': 'Hakilina ma se ka ci.',
    'comments.required': 'Yɔrɔ wajibiyalenw',
    'comments.fillAll': 'I ka yɔrɔ bɛɛ dafa.',
    'comments.submit': 'Hakilina ci',
    'comments.moderation': 'I ka hakilina bɛna yira ɲɛmɔgɔ ka lajɛli kɔfɛ.',
    'comments.namePlaceholder': 'I tɔgɔ',
    'comments.emailPlaceholder': 'i@email.com',
    'comments.comment': 'Hakilina',
    'comments.commentPlaceholder': 'I ka miiriya fɔ...',
    'seo.home.title': 'Inocent KOFFI - AGRICAPITAL SARL ɲɛmɔgɔ | Sɛnɛ yiriwali',
    'seo.home.description': 'Inocent KOFFI, AGRICAPITAL SARL ɲɛmɔgɔ. San 12 foro kɔnɔ dɔnniya sɛnɛkɛlaw fɛ Kotidiwari.',
    'seo.about.title': 'N ka kunnafoni - Inocent KOFFI | Sira ni sɛnɛ dɔnniya',
    'seo.about.description': 'Inocent KOFFI ka sira lajɛ: san 12 mara 8 kɔnɔ Kotidiwari togodamɔgɔw cɛma.',
    'seo.vision.title': 'Hakilinata - Inocent KOFFI | Ka Afiriki sɛnɛ yiriwa',
    'seo.vision.description': 'Inocent KOFFI ka hakilinata: ka Afiriki sɛnɛ yiriwa sira banbali kan.',
    'seo.contact.title': 'Ne weele - Inocent KOFFI | Jɛ baara ni jɛɲɔgɔnya',
    'seo.contact.description': 'Inocent KOFFI weele walasa ka baro sɛnɛ baaraw, jɛɲɔgɔnya walima jɛ baara kan.',
  },
};
