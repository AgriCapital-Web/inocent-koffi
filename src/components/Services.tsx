...
const Services = () => {
  ...
  const copy = {
    ...
    bci: { title: "Ninnge nga e man", accent: "e man", desc: "Ukalɛ kpa ɔ fie aɲanbeun ti", items: ["Fie kwlaa yolɛ", "Mma kpakpa, asiɛ nunnunlɛ, waka tulɛ, tanndɛ, aliɛ manlɛ nin asiɛ yiyilɛ — anglo 36 nun be fa man ɔ.", "Junman su nianlɛ", "Junman silɛfuɛ mun be ba, be man afɔtuɛ naan be nian su titi fluwa'n i blɛ kwlaa nun.", "Atɛ tolɛ nda", "Atɛ yolɛ lika sielɛ nin sika nga ɔ ba titi afuɛ 25 nun e bo yofuɛ dandan mun be lika."] },
    dyu: { title: "An bɛ min di", accent: "min di", desc: "Dɛmɛ labɛnnen i ka sɛnɛ nafolo kama", items: ["Foro dilanni pewu", "Denw ɲumanw, dugukolo saniyali, jiribolo, sɛnɛli, nafɛnw ani nɔgɔ — kalo 36 kɔnɔ a bɛ di i ma baara kɛta.", "Baara ɲɛnabɔli", "Dɔnniyabaaw ka taamaw, sɛnɛ ladili ani dɛmɛ banbali bɛnkan waati bɛɛ la.", "Sanni layidu", "Feereyɔrɔ lakanalen ni wari sɔrɔ sabatilen san 25 kɔnɔ an ka baaraɲɔgɔn babaw fɛ."] }
  }[language];
