...
const Hero = () => {
  ...
  const copy = {
    fr: {
      founder: "Fondateur & CEO — AGRICAPITAL SARL",
      role: "Agro-Entrepreneur & Stratège Agricole",
      description: "Agro-entrepreneur et stratège en développement agricole. Fondateur & CEO d'AGRICAPITAL SARL — opérateur et promoteur agricole spécialisé dans la création de plantations de palmier à huile clé en main en Côte d'Ivoire. 12+ années d'immersion terrain au service de l'agriculture et de l'innovation.",
      contact: "Me Contacter",
      discover: "Découvrir AGRICAPITAL"
    },
    en: {
      founder: "Founder & CEO — AGRICAPITAL SARL",
      role: "Agro-Entrepreneur & Agricultural Strategist",
      description: "Agro-entrepreneur and agricultural development strategist. Founder & CEO of AGRICAPITAL SARL — an agricultural operator and promoter specialized in turnkey oil palm plantations in Côte d'Ivoire. 12+ years of field immersion serving agriculture and innovation.",
      contact: "Contact Me",
      discover: "Discover AGRICAPITAL"
    },
    es: {
      founder: "Fundador y CEO — AGRICAPITAL SARL",
      role: "Agroemprendedor y Estratega Agrícola",
      description: "Agroemprendedor y estratega en desarrollo agrícola. Fundador y CEO de AGRICAPITAL SARL, operador y promotor agrícola especializado en la creación de plantaciones de palma aceitera llave en mano en Costa de Marfil. Más de 12 años de inmersión sobre el terreno al servicio de la agricultura y la innovación.",
      contact: "Contactarme",
      discover: "Descubrir AGRICAPITAL"
    },
    de: {
      founder: "Gründer & CEO — AGRICAPITAL SARL",
      role: "Agro-Unternehmer & Agrarstratege",
      description: "Agro-Unternehmer und Stratege für landwirtschaftliche Entwicklung. Gründer & CEO von AGRICAPITAL SARL — landwirtschaftlicher Betreiber und Projektentwickler, spezialisiert auf schlüsselfertige Ölpalmenplantagen in Côte d'Ivoire. Mehr als 12 Jahre Praxiserfahrung im Dienst von Landwirtschaft und Innovation.",
      contact: "Kontaktieren",
      discover: "AGRICAPITAL entdecken"
    },
    zh: {
      founder: "创始人兼 CEO — AGRICAPITAL SARL",
      role: "农业创业者与农业战略家",
      description: "农业创业者与农业发展战略家。AGRICAPITAL SARL 创始人兼 CEO，专注于在科特迪瓦打造交钥匙油棕种植园的农业运营与推广者。12年以上扎根一线，服务农业与创新。",
      contact: "联系我",
      discover: "了解 AGRICAPITAL"
    },
    ar: {
      founder: "المؤسس والرئيس التنفيذي — AGRICAPITAL SARL",
      role: "رائد أعمال زراعي واستراتيجي زراعي",
      description: "رائد أعمال زراعي واستراتيجي في التنمية الزراعية. مؤسس ورئيس AGRICAPITAL SARL، وهي جهة تشغيل وتطوير زراعي متخصصة في إنشاء مزارع نخيل زيت متكاملة في كوت ديفوار. أكثر من 12 سنة من الخبرة الميدانية في خدمة الزراعة والابتكار.",
      contact: "تواصل معي",
